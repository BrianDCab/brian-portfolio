...
return ( <header className="sticky top-0 z-50 border-b border-white/10 bg-black/75 backdrop-blur-xl"> <div className="mx-auto max-w-7xl px-4 md:px-6"> <div className="hidden items-center justify-between gap-6 py-4 lg:flex"> <Link href="/" className="group shrink-0"> <div className="text-sm font-black tracking-[0.32em] text-white transition group-hover:text-cyan-300">
BC </div> <div className="text-[10px] uppercase tracking-[0.28em] text-cyan-300/70">
Data • Code • Systems </div> </Link>
