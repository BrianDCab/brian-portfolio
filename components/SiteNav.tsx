...
const neutralButton =
"border border-white/10 bg-white/5 text-zinc-300 hover/40 hover/10 hover";

const activeButton =
"bg-cyan-400 text-black shadow-[0_0_24px_rgba(34,211,238,0.35)]";

const registerButton =
"border border-cyan-300/40 bg-cyan-400 text-black hover";

const logoutButton =
"border border-red-300/25 bg-red-300/10 text-red-100 hover/20";
